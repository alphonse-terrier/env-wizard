...
curl -L https://github.com/alphonse-terrier/env-wizard/releases/download/v0.3.1/env-wizard-v0.3.1-aarch64-apple-darwin.tar.gz | tar xz
sudo mv env-wizard-v0.3.1-aarch64-apple-darwin/env-wizard /usr/local/bin/
```
...
```sh
curl -L https://github.com/alphonse-terrier/env-wizard/releases/download/v0.3.1/env-wizard-v0.3.1-x86_64-unknown-linux-musl.tar.gz | tar xz
sudo mv env-wizard-v0.3.1-x86_64-unknown-linux-musl/env-wizard /usr/local/bin/
```
